...
$update = 'UPDATE `GOAL` SET `category` = :category, `description` = :description, `leafNumber` = :leafNumber, `leafPoints` = :leafPoints, '
        . '`webLink1` = :webLink1, `webLink1Text` = :webLink1Text, `webLink2` = :webLink2, `webLink2Text` = :webLink2Text, `webLink3` = :webLink3, `webLink3Text` = :webLink3Text, '
        . '`otherNotes` = :otherNotes, `required` = :required, `availability` = :availability WHERE `idGoals` = :idGoals';
...
if ($success) {
    $message = "Thank you for updating an existing item.";
}
...
<html>
    ...
    <body>
        <div class="container-fluid"> 
            ...
            <a href="../adminWorksheet.php" class="btn btn-large btn-primary disabled">Back to Form</a>
